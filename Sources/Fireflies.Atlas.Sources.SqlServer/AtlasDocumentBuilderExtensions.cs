...
public static class AtlasDocumentBuilderExtensions {
    ...
    public static AtlasDocumentBuilder<TDocument> SqlServerTableSource<TDocument>(this AtlasDocumentBuilder<TDocument> builder, SqlServerSource source, SqlNameDescriptor descriptor, Action<SqlServerTableSourceBuilder<TDocument>>? configure = null) where TDocument : new() {
    ...
    public static AtlasDocumentBuilder<TDocument> SqlServerViewSource<TDocument>(this AtlasDocumentBuilder<TDocument> builder, SqlServerSource source, string descriptor, Action<SqlServerArbitrarySourceBuilder<TDocument>> configure) where TDocument : new() {
        return builder.SqlServerViewSource(source, new SqlNameDescriptor(descriptor), configure);
    }

    public static AtlasDocumentBuilder<TDocument> SqlServerViewSource<TDocument>(this AtlasDocumentBuilder<TDocument> builder, SqlServerSource source, string schema, string table, Action<SqlServerArbitrarySourceBuilder<TDocument>> configure) where TDocument : new() {
        return builder.SqlServerViewSource(source, new SqlNameDescriptor(schema, table), configure);
    }

    public static AtlasDocumentBuilder<TDocument> SqlServerViewSource<TDocument>(this AtlasDocumentBuilder<TDocument> builder, SqlServerSource source, SqlNameDescriptor viewDescriptor, Action<SqlServerArbitrarySourceBuilder<TDocument>> configure) where TDocument : new() {
    ...
    public static AtlasDocumentBuilder<TDocument> SqlServerQuerySource<TDocument>(this AtlasDocumentBuilder<TDocument> builder, SqlServerSource source, string query, Action<SqlServerArbitrarySourceBuilder<TDocument>> configure) where TDocument : new() {
        return builder.SqlServerQuerySource(source, new SqlQueryDescriptor(query), configure);
    }

    public static AtlasDocumentBuilder<TDocument> SqlServerQuerySource<TDocument>(this AtlasDocumentBuilder<TDocument> builder, SqlServerSource source, SqlQueryDescriptor queryDescriptor, Action<SqlServerArbitrarySourceBuilder<TDocument>> configure) where TDocument : new() {
        var sqlServerViewSourceBuilder = new SqlServerArbitrarySourceBuilder<TDocument>();
        configure(sqlServerViewSourceBuilder);
